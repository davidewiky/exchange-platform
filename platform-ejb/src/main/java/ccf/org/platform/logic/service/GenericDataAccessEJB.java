...
import ccf.org.platform.logic.jpa.CriteriaHelper;
import ccf.org.platform.logic.jpa.SingleRootCriteriaQuery;
...
public class GenericDataAccessEJB<T extends AbstractEntity> extends DataAccessEJB {
	 ...
	 */
	@TransactionAttribute(TransactionAttributeType.NOT_SUPPORTED)
	public List<T> find(final T example, final Class<T> entityClass, final QueryAttributes queryAttributes)
	...
	private List<T> find(final T example, final Class<T> entityClass, final QueryAttributes queryAttributes,
		...
		final List<Predicate> predicates = like ? helper.qbel(container.getRoot(), cb, example) : helper.qbe(container
				.getRoot(), cb, example);
	 ...
	 */
	@TransactionAttribute(TransactionAttributeType.NOT_SUPPORTED)
	public List<T> find(final T example, final Class<T> entityClass, final SetAttribute<T, ?> attribute)
			throws DatabaseException {
		logger.info(getClass().getSimpleName() + "-find");
	...
	@TransactionAttribute(TransactionAttributeType.NOT_SUPPORTED)
	public List<T> find(final T example, final Class<T> entityClass, final SetAttribute<T, ?> attribute,
			final QueryAttributes queryAttributes) throws DatabaseException {
		logger.info(getClass().getSimpleName() + "-find");
	 ...
	 */
	@TransactionAttribute(TransactionAttributeType.NOT_SUPPORTED)
	public T findUnique(final T example, final Class<T> entityClass, final SetAttribute<T, ?> attribute)
			throws DatabaseException {
